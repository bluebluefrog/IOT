		...
		<fieldset>
			...
			<table cellspacing="0px">
				...
				<tr>
					...
					<td>${user.email}</td>
					<td>
						<a class="oplink" data-preview="${user.img}" data-pname="${user.username}" href="javascript:void(0)" onclick="showPreview(this)">preview</a>
						<a class="oplink" href="#" onclick="showUpdateUser(${user.userId})">update</a>
						<a class="oplink" href="javascript:void(0)" data-id="${user.userId}" data-pname="${user.username}" data-preview="${user.img}" onclick="del(this)">delete</a>
					</td>
				</tr>
				</c:forEach>
			</table>
